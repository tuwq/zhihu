<template>
 	<div class="comments-container">
 		<div class="comments-inner">
 			...
 			<div>
 				<div class="comment-list" v-if="commentList && load">
 						...
 						<div>
 							...
 							<div class="comment-editor" style="display: none;">
 								<div class="editor-top">
 									<textarea class="editor-input" v-model="comment_text" :placeholder="'回复'+item.user_id.username"></textarea>
 								</div>
