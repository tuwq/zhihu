<template>
 	<div class="mask" v-show="ModalStatus">
 		<div class="backdrop" @click.stop.prevent="clsModal"></div>
 		<div class="modal-fullPage">
 							...
 							<div class="CommentItem">
 								<div>
 									...
 									<div class="item-content">
 										<p>从新人学习的角度的话，vue确实要比react快太多。文档翔实，上手简单。react的redux mobx router确实比较难以理解</p>
 									</div>
 			...
 			<div class="Modal-closeButton" @click.stop.prevent="clsModal">
