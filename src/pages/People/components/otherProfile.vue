			...
			<div class="bottom">
				<div class="userInfo-box">
					...
					<div class="info" v-if="otherUser.info">
						...
						<div class="buttons">
							<button class="attention" v-show="fllowerStatus==0" 
							...
							<button class="attention cancel" v-show="fllowerStatus==1" type="button" 
							@click.stop.prevent="followPeople(otherUser._id,0)" 
