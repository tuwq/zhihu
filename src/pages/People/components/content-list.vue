					...
					<div class="item-answer-box">
						...
						<div class="answer-content-box">
							<div class="richContent-box">
								<div>
									<span class="rich-text">你们这些天天讨论语言的真是无聊的要死。要是找工作的话难道不是什么用的赚钱用什么吗？C#找不到工作你不会换JAVA吗？JAVA找不到换erlang啊！Erlang找不到你换PHP呗！PHP要是都找不到了你去卖水果啊！要是自己干点什么难道不是什么上手快就什么嘛？明明C#一会儿搞定的事情非要写上几千行的配置文件来配JAVA SSH?有病吧！明明有现成的JAVA代码库非要换不熟悉的PHP把坑都走一遍？有病吧。  你们这帮人啊。 naïve！ 等你们到了我这年龄才会知道，什么语言啊都是虚无，虚无，虚无！</span>
									<button class="getMore">阅读全文<svg viewBox="0 0 10 6" width="10" height="16"><title></title><g><path d="M8.716.217L5.002 4 1.285.218C.99-.072.514-.072.22.218c-.294.29-.294.76 0 1.052l4.25 4.512c.292.29.77.29 1.063 0L9.78 1.27c.293-.29.293-.76 0-1.052-.295-.29-.77-.29-1.063 0z"></path></g></svg></button>
								</div>
							</div>
