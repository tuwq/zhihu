	  		...
	  		<div class="profile" v-if="user">
	  			<div class="Popover header-menu">
	  				<button  v-if="user.avatar" @click.stop.prevent="openDrop" class="Button button profileEntry button--plain" type="button">
	  					<img :src="imageServer+user.avatar" width="34" height="34" class="Avatar header-avatar">
	  				</button>
...
import { getNowUserApi } from 'api/user'
	export default {
		name: 'zHeader',
		data() {
			return {
