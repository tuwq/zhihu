			...
			<div class="header">
				...
				<div class="twoLine">
					<span class="user-avatar"><div class="Popover">
						...
						<img class="avatar-img"  width="24" height="24" :src="item.anonymousStatus==0
						?imageServer+item.user_id.avatar
						:static+'avatar.png'">
					</a></div></span>
...
<script type="text/ecmascript-7">
	...
	import { questionVoteApi } from 'api/question'
	export default {
		mixins: [userMixin],
		props: {
			item: {
